...
import { benefits } from "../assets/constants";
          ...
          {benefits.map((item) => (
            ...
            >
              <div className="relative z-2 flex flex-col min-h-88 p-[2.4rem] pointer-events-none">
                <h5 className="h5 mb-5 font-serif tracking-wide">
                  {item.title}
                </h5>
                ...
                <div className="flex items-center mt-auto">
                  <img
                    ...
                    alt={item.title}
                  />
                  <p className="ml-auto font-serif text-xs font-semibold text-n-1 uppercase tracking-wider">
                    Explore more
                  </p>
                  <Arrow />
                </div>
